...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 1) Check if email ena password exist
  if (!email || !password) {
...
// Only for renderd pages, no errors sent!
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  // 1) Get user based on posted email .select('+password')
...
// exports.mymodule-tocatch = catchAsync(async (req, res, next) => {});
